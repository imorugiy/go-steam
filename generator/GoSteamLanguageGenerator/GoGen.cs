...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        public void EmitClasses(dynamic root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"github.com/imorugiy/go-steam/steamid\"");
            sb.AppendLine("    \"github.com/imorugiy/go-steam/rwu\"");
            sb.AppendLine("    \"github.com/imorugiy/go-steam/protocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
